...
export interface ApiBioBio extends Schema.SingleType {
  ...
  attributes: {
    artistStatement: Attribute.RichText;
    events: Attribute.Component<'bio.event', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiGroupGroup extends Schema.CollectionType {
  ...
  attributes: {
    pageData: Attribute.Component<'work.page-data'> & Attribute.Required;
    images: Attribute.Component<'media.image', true> & Attribute.Required;
    tabName: Attribute.String & Attribute.Required & Attribute.Unique;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiLessonPageLessonPage extends Schema.SingleType {
  collectionName: 'lesson_pages';
  info: {
    singularName: 'lesson-page';
    pluralName: 'lesson-pages';
    displayName: 'Lesson Page';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiNovelNovel extends Schema.CollectionType {
  ...
  attributes: {
    pageData: Attribute.Component<'work.page-data'> & Attribute.Required;
    coverImage: Attribute.Component<'media.image'> & Attribute.Required;
    pages: Attribute.Media & Attribute.Required;
    tabName: Attribute.String & Attribute.Required & Attribute.Unique;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
